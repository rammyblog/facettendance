...
# Face recgonition code
def face_rec_login(image_urls, usernames, matric_nos, student_login=False):
    ...
    recgonized_faces_matric_no = set()

    for username in usernames:
        known_face_names.append(username)

    for matric_no in matric_nos:
        known_matric_no.append(matric_no)

    # Load a sample picture and learn how to recognize it.
    for image_url in image_urls:
        user_image = face_recognition.load_image_file(image_url)
        ...
        if process_this_frame:
            ...
            for face_encoding in face_encodings:
                ...
                if matches[best_match_index]:
                    ...
                    matric_no = known_matric_no[best_match_index]


                face_names.append(name)
                face_auth = True
                print(name, matric_no)
                recgonized_faces_matric_no.add(matric_no)
